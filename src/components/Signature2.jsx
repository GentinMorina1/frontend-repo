    ...
    <div className="content2">
      <div className="signature-content2">
        {formData.croppedImage && renderImagePreview(
          typeof formData.croppedImage === 'string' && formData.croppedImage.includes('http')
            ? formData.croppedImage
            : URL.createObjectURL(formData.croppedImage)
        )}
        <div className="signature-details2">
          ...
          <div className="socialmedia-links2">
            ...
            {formData.gif && (
              <img style={{ width: "82px", height: "42px" }} src={URL.createObjectURL(formData.gif)} />
            )}
          </div>
        </div>
        <div className="companies2">
          {formData.company_logo && (
            <img className="company-logo2" style={{ width: "100px" }} src={URL.createObjectURL(formData.company_logo)} />
          )}
          {formData.company_logo1 && (
            <img className="" style={{ width: "200px" }} src={URL.createObjectURL(formData.company_logo1)} />
          )}
          {formData.company_logo2 && (
            <img className="" style={{ width: "150px" }} src={URL.createObjectURL(formData.company_logo2)} />
          )}
        </div>
